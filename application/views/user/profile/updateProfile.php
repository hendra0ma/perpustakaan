                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body" style="display: block;">
                                        <form action="" method="post" enctype='multipart/form-data'>
                                            ...
                                            <div class="input-group mb-3">
                                                <textarea class="form-control" placeholder="alamat" name="alamat" cols="30" rows="10"><?= $user->alamat ?></textarea>
                                                <div class="input-group-append">
                                                    <div class="input-group-text">
                                                        <span class="fas fa-user-tag    "></span>
                                                    </div>
                            ...
                            <div class="col-md-4">
                                <center>
                                    ...
                                    <?php else : ?>
                                        <img src="<?= base_url() ?>assets/dashboard/docs/assets/img/upload/<?= $user->gambar ?>" alt="Image Admin" class="img-fluid image" style="border-radius:10px;">
                                    <?php endif; ?>
                                </center>
