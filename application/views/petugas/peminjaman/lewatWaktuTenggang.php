    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-2 mt-3">
                ...
                <div class="col-lg-2 col-md-2">
                    <a href="<?= base_url('dashboard/petugas/export/generateBukuLewatWaktuTenggang') ?>" class="btn btn-light"><i class="fas fa-file"></i> Export PDF</a>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        foreach ($lewatWaktuTenggang as $data) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url() ?>dashboard/petugas/peminjaman/kembalikanLewatWaktuTenggang/<?= $data->id_peminjaman ?>/dikembalikan/" class="badge badge-success">Di Kembalikan</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
