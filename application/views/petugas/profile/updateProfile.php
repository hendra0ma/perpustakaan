                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body" style="display: block;">
                                        <form action="" method="post" enctype='multipart/form-data'>
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" placeholder="Full name" name="nama_admin" value="<?= $petugas->nama_petugas ?>">
                            ...
                            <div class="col-md-4">
                                <center>
                                    ...
                                    <?php else : ?>
                                        <img src="<?= base_url() ?>assets/dashboard/docs/assets/img/upload/<?= $petugas->gambar ?>" alt="Image Admin" class="img-fluid image" style="border-radius:10px;">
                                    <?php endif; ?>
                                </center>
