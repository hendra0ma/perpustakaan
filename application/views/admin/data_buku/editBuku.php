<div class="container">
    <div class="row">
        <div class="col-md-12">
            <center>
                <strong>
                    <h2 class="alert alert-dark">Edit Buku</h2>
                </strong>
            </center>
        </div>
    </div>
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama_buku" name="nama_buku" placeholder="nama buku" value="<?= $buku->nama_buku ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="stock_buku" name="stock_buku" placeholder="stock buku" value="<?= $buku->stock_buku ?>">
                            <div class="badge text-danger"><?= form_error('stock_buku') ?></div>
                        </div>
                        <div class="form-group">
                            <label for="deskripsi_buku">deskripsi buku</label>
                            <textarea class="form-control" id="deskripsi_buku" name="deskripsi_buku" placeholder="deskripsi buku" cols="30" rows="10"><?= $buku->deskripsi_buku ?></textarea>
        ...
        <div class="col-md-4">
            <center>
                <img src="<?= base_url('assets/dashboard') ?>/docs/assets/img/upload/<?= $buku->gambar_buku ?>" alt="Image Admin" class="img-fluid image" style="height:350px !important;border-radius:10px;">
            </center>
        </div>
    </div>
